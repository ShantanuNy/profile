...
function Projects({ projects }: Props) {
	return (
		<motion.div
			...
			<div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#FF0000]/80">
					...
					<motion.div
						...
						<div className="space-y-10 px-0 md:px-10 max-w-6xl">
							<h4 className="text-4xl font-semibold text-center">
								<span className="decoration-[#FFFFFF]/50 underline">
