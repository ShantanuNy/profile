		...
		<motion.div
			...
			<div className="flex flex-col space-y-10">
				<h4 className="text-4xl font-semibold text-center">
					...
					<span className="decoration-[#FFFFF]/50 underline">Lets Talk.</span>
				</h4>
				...
				<div className="space-y-10">
					...
					<div className="flex items-center space-x-5 justify-center">
						<EnvelopeIcon className="text-[#ff2828] h-7 w-7 animate-pulse" />
						<a className="text-2xl" href={`mailto:${pageInfo.email}`}>
							{pageInfo.email}
						</a>
					</div>
					<div className="flex items-center space-x-5 justify-center">
						<MapPinIcon className="text-[#ff0e0e] h-7 w-7 animate-pulse" />
				...
				<form
					...
					<button
						type="submit"
						className="
            bg-[#b60f0f] py-5 px-10 rounded-md text-white font-bold text-lg ">
						Submit
					</button>
				</form>
			</div>
